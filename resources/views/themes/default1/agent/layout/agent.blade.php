                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        ...
                        <ul class="tabs tabs-horizontal nav navbar-nav navbar-left">
                            ...
                            <li @yield('Cdn')><a data-target="#tabD" href="#">{!! Lang::get('lang.Cdn') !!}</a></li>
                            <li @yield('Tools')><a data-target="#tabE" href="#">{!! Lang::get('lang.tools') !!}</a></li>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    <div class="user-panel">
                        <div class="pull-left">
                            <a href="{!! url('profile') !!}"><img src="{{$auth_user_profile_pic}}" class="img-circle" alt="User Image" style="max-width: 45px"/></a>
                        </div>
                    ...
                    <ul id="side-bar" class="sidebar-menu">
                        ...
                        <li @yield('resources')>
                             <a href="{{ url('resources')}}" id="load-resources">
                                ...
                                <small class="label pull-right bg-green">{{$resources->count()}}</small>
                            </a>
                        </li>
...
<?php if (is_object(    $group) && $group->can_create_ticket == 1) { ?>
                                ...
                                <div class="tabs-pane @yield('cdn-bar')" id="tabD">
                                    <ul class="nav navbar-nav">
                                ...
                                @if($auth_user_role == 'admin')
                                <div class="tabs-pane @yield('report-bar')" id="tabF">
                                    <ul class="nav navbar-nav">
                                    </ul>
                                </div>
                                @endif
