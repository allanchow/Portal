...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">{!! $dept_name !!} / {!! $status or '' !!} </h3>
    </div><!-- /.box-header -->
    ...
    <div class="box-body ">
        ...
        <div class="mailbox-messages" id="refresh">
            <!--datatable-->
            {!! isset($table) ? $table->render('vendor.Chumper.template') : ''!!}
...
{!! isset($table) ? $table->script('vendor.Chumper.ticket-dept-javascript') : '' !!}
<script>
