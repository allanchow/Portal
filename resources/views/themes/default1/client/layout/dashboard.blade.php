...
<html>
    ...
    <body class="skin-blue fixed">
        ...
        <script type="text/javascript">
            ...
            po.src = '//livehelperchat.allbrightnet.com'+lang+'/chat/getstatus/(click)/internal/(position)/bottom_right/(ma)/br/(hide_offline)/true/(check_operator_messages)/true/(top)/350/(units)/pixels/(identifier)/Portal?r='+ referrer+'&l='+location;
