...
//    });
    ...
    //Route::get('/', ['as' => '/', 'uses' => 'Agent\helpdesk\DashboardController@index']); /* To show dashboard pages */
...
//===================================================================================
    Route::group(['middleware' => 'role.user', 'middleware' => 'auth'], function () {
        Route::get('home', ['as' => 'home', 'uses' => 'Client\helpdesk\DashboardController@index']); //guest layout
...
//====================================================================================
    Route::group(['middleware' => 'auth'], function () {
        //CDN
        Route::get('resources', ['as' => 'resources',  'uses' =>'Cdn\CdnController@index']);
        //Route::get('resource/{id}', ['as' => 'resource', 'uses' => 'Cdn\CdnController@edit']);
...
//    });
    ...
    /* get the home page */
    Route::get('knowledgebase', ['as' => 'knowledgebase', 'uses' => 'Client\kb\UserController@home']);
